...
if __name__ == "__main__":
    ...
    for level in levels:
        ...
        fpath = f"_experiments/noised_sawtooth_diff_targ/convcnp_500_epochs/{level}/log_train.txt"
        ...
        plot_train_val_curves(train_losses, val_losses, f"train_val_curves_new_split_{level}_500_epochs")