...
def setup(name, args, config, *, num_tasks_train, num_tasks_cv, num_tasks_eval, device):
    ...
    gen_train = nps.construct_predefined_gens(
        ...
        dim_x=args.dim_x,
        dim_y=args.dim_y if name not in ["noised_sawtooth", "noised_sawtooth_diff_targ", "noised_square_wave_diff_targ"] else 1,
        pred_logpdf=False,
...
names = [
    ...
    "sawtooth",
    "noised_sawtooth",
    "noised_sawtooth_diff_targ",
    "noised_square_wave_diff_targ",
    "mixture",
]
